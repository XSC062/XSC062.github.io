// 魔改ed from @UniGravity, https://www.luogu.com.cn/user/582360
...
async function searchContent() {
    ...
    results.forEach(item => {
        ...
        const div1 = document.getElementById("hintext1");
        const box1 = document.getElementById("ansbox1");
        const customConfirm1 = document.getElementById('customConfirm1');
        const confirmYes1 = document.getElementById('confirmYes1');
        const confirmNo1 = document.getElementById('confirmNo1');
        btn1.addEventListener("click", () => {
            customConfirm1.style.display = 'none';
            btn1.classList.toggle("hintbtndown");
            div1.classList.toggle("transhint");
            box1.classList.toggle("bigansbox");
        });
        ...
        const div2 = document.getElementById("hintext2");
        const box2 = document.getElementById("ansbox2");
        const customConfirm2 = document.getElementById('customConfirm2');
        const confirmYes2 = document.getElementById('confirmYes2');
        const confirmNo2 = document.getElementById('confirmNo2');
        btn2.addEventListener("click", () => {
            customConfirm2.style.display = 'none';
            btn2.classList.toggle("hintbtndown");
            div2.classList.toggle("transhint");
            box2.classList.toggle("bigansbox");
        });
        ...
        const div3 = document.getElementById("hintext3");
        const box3 = document.getElementById("ansbox3");
        const customConfirm3 = document.getElementById('customConfirm3');
        const confirmYes3 = document.getElementById('confirmYes3');
        const confirmNo3 = document.getElementById('confirmNo3');
        btn3.addEventListener("click", () => {
            customConfirm3.style.display = 'none';
            btn3.classList.toggle("hintbtndown");
            div3.classList.toggle("transhint");
            box3.classList.toggle("bigansbox");
        });
        ...
        confirmNo3.addEventListener('click', () => { 
            customConfirm3.style.display = 'none';
        });

        const btn4 = document.getElementById("hintbtn4");
        const div4 = document.getElementById("hintext4");
        const box4 = document.getElementById("ansbox4");
        const customConfirm4 = document.getElementById('customConfirm4');
        const confirmYes4 = document.getElementById('confirmYes4');
        const confirmNo4 = document.getElementById('confirmNo4');
        btn4.addEventListener("click", () => {
            customConfirm4.style.display = 'none';
            btn4.classList.toggle("hintbtndown");
            div4.classList.toggle("transhint");
            box4.classList.toggle("bigansbox");
        });
        confirmYes4.addEventListener('click', () => {
            customConfirm4.style.display = 'none';
            btn4.classList.toggle("hintbtndown");
            div4.classList.toggle("transhint");
            box4.classList.toggle("bigansbox");
        });
        confirmNo4.addEventListener('click', () => { 
            customConfirm4.style.display = 'none';
        });

        const btn5 = document.getElementById("hintbtn5");
        const div5 = document.getElementById("hintext5");
        const box5 = document.getElementById("ansbox5");
        const customConfirm5 = document.getElementById('customConfirm5');
        const confirmYes5 = document.getElementById('confirmYes5');
        const confirmNo5 = document.getElementById('confirmNo5');
        btn5.addEventListener("click", () => {
            customConfirm5.style.display = 'none';
            btn5.classList.toggle("hintbtndown");
            div5.classList.toggle("transhint");
            box5.classList.toggle("bigansbox");
        });
        confirmYes5.addEventListener('click', () => {
            customConfirm5.style.display = 'none';
            btn5.classList.toggle("hintbtndown");
            div5.classList.toggle("transhint");
            box5.classList.toggle("bigansbox");
        });
        confirmNo5.addEventListener('click', () => { 
            customConfirm5.style.display = 'none';
        });
    });
}
